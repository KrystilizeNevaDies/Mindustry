    ...
    private static final Cons<Bullet> shieldConsumer =
            b -> {
                if (b.team != paramUnit.team
                        ...
                        .set(b)
                        .add(b.vel)
                        .within(paramPos, paramField.radius + paramField.width / 2f)
                        && Angles.within(
                        paramPos.angleTo(b),
                        paramUnit.rotation + paramField.angleOffset,
                        paramField.angle / 2f)) {
    ...
    public void update(Unit unit) {
        ...
        if (active) {
            ...
            Groups.bullet.intersect(
                    unit.x - radius, unit.y - radius, radius * 2f, radius * 2f, shieldConsumer);
        } else {
            ...
            if (Vars.renderer.animateShields) {
                ...
                if (drawArc) {
                    ...
                    Lines.arc(
                            ...
                            radius,
                            angle / 360f,
                            unit.rotation + angleOffset - angle / 2f);
                }
            } else {
                // TODO
                Lines.stroke(1.5f);
