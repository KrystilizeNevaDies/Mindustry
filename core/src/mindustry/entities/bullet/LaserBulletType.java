...
public class LaserBulletType extends BulletType {
    public Color[] colors = {
            Pal.lancerLaser.cpy().mul(1f, 1f, 1f, 0.4f), Pal.lancerLaser, Color.white
    };
                            ...
                            () -> {
                                if (b.isAdded() && b.type == this) {
                                    Lightning.create(
                                            ...
                                            cx,
                                            cy,
                                            rot + 90 * s + Mathf.range(lightningAngleRand),
    ...
    public void draw(Bullet b) {
        ...
        for (Color color : colors) {
            ...
            for (int i : Mathf.signs) {
                Drawf.tri(
                        b.x,
                        b.y,
                        sideWidth * b.fout() * cwidth,
                        sideLength * compound,
                        b.rotation() + sideAngle * i);
            }
        ...
        Drawf.light(
                b.x, b.y, b.x + Tmp.v1.x, b.y + Tmp.v1.y, width * 1.4f * b.fout(), colors[0], 0.6f);
    }
