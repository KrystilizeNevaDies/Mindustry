...
public class RailBulletType extends BulletType {
    ...
    public void init(Bullet b) {
        ...
        any = false;
        Damage.collideLine(
                b, b.team, b.type.hitEffect, b.x, b.y, b.rotation(), length, false, false);
        ...
        if (lineEffect != Fx.none) {
            lineEffect.at(
                    b.x, b.y, b.rotation(), hitColor, new Vec2(b.x, b.y).mulAdd(nor, resultLen));
        }
    }
    ...
    @Override
    public void hitTile(
            Bullet b, Building build, float x, float y, float initialHealth, boolean direct) {
