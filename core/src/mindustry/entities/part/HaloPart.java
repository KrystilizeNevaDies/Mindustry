...
public class HaloPart extends DrawPart {
    ...
    public void draw(PartParams params) {
        ...
        float prog = progress.getClamp(params),
                ...
                haloRad =
                        haloRadiusTo < 0 ? haloRadius : Mathf.lerp(haloRadius, haloRadiusTo, prog);
        ...
        for (int s = 0; s < len; s++) {
            ...
            for (int v = 0; v < shapes; v++) {
                ...
                float shapeX = Angles.trnsx(rot, haloRad) + rx,
                        shapeY = Angles.trnsy(rot, haloRad) + ry;
                float pointRot =
                        rot + shapeMoveRot * prog * sign + shapeRotation * sign + baseRot * sign;
