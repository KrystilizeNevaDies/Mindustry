...
public abstract class DrawPart {
    ...
    public interface PartProgress {
         ...
         */
        PartProgress reload = p -> p.reload,
        /**
         * Reload, but smoothed out, so there is no sudden jump between 0-1.
         */
        smoothReload = p -> p.smoothReload,
        /**
         * Weapon warmup, 0 when not firing, 1 when actively shooting. Not equivalent to
         * heat.
         */
        warmup = p -> p.warmup,
        /**
        ...
        recoil = p -> p.recoil,
        /**
         * Weapon heat, 1 when just fired, 0, when it has cooled down (duration depends on
         * weapon)
         */
        heat = p -> p.heat,
        /**
