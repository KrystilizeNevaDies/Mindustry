...
public class CacheLayer {
    public static CacheLayer water, mud, cryofluid, tar, slag, arkycite, space, normal, walls;
    ...
    public static void add(CacheLayer... layers) {
        ...
        var prev = all;
        // reallocate the array and copy everything over; performance matters very little here
        // anyway
