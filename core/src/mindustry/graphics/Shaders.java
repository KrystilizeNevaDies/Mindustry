...
public class Shaders {
    ...
    public static class AtmosphereShader extends LoadShader {
        ...
        public void apply() {
            ...
            setUniformf(
                    "u_color",
                    planet.atmosphereColor.r,
                    planet.atmosphereColor.g,
                    planet.atmosphereColor.b);
    ...
    public static class SpaceShader extends SurfaceShader {
        ...
        public SpaceShader(String frag) {
            ...
            Core.assets.load("sprites/space.png", Texture.class).loaded =
                    t -> {
                        texture = t;
    ...
    public static class SurfaceShader extends Shader {
        ...
        public void loadNoise() {
            Core.assets.load("sprites/" + textureName() + ".png", Texture.class).loaded =
                    t -> {
