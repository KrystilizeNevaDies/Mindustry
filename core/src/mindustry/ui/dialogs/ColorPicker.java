    ...
    public void show(Color color, boolean alpha, Cons<Color> consumer) {
        ...
        cont.pane(
                t -> {
                    ...
                    t.stack(
                                    new Image(new TextureRegion(hueTex)),
                                    hSlider =
                                            new Slider(0f, 360f, 0.3f, false) {
                                                {
                                                    setValue(h);
                                                    moved(
                                                            value -> {
                    ...
                    if (alpha) {
                        t.stack(
                                        new Image(Tex.alphaBgLine),
                                        new Element() {
                                            @Override
                                            public void draw() {
                                                float first =
                                                        Tmp.c1.set(current).a(0f).toFloatBits();
                                                float second =
                                                        Tmp.c1
                                                                .set(current)
                                                                .a(parentAlpha)
                    ...
                    hexField =
                            t.field(
                                    ...
                                    .valid(
                                            text -> {
                                                // garbage performance but who cares this runs only
