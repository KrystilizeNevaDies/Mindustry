...
public class LoadoutDialog extends BaseDialog {
    ...
    public void maxItems() {
        for (ItemStack stack : stacks) {
            stack.amount =
                    total == null
                            ? capacity
                            : Math.max(Math.min(capacity, total.get(stack.item)), 0);
        }
    }
                                ...
                                t.button(
                                                ...
                                                () ->
                                                        ui.showTextInput(
                                                                ...
                                                                true,
                                                                str -> {
                                                                    if (Strings.canParsePositiveInt(
                                                                            str)) {
                                                                        int amount =
                                                                                Strings.parseInt(
                                                                                        str);
    ...
    private void reseed() {
        ...
        this.stacks.addAll(
                content.items()
                        .select(i -> validator.get(i) && !stacks.contains(stack -> stack.item == i))
