...
public class AboutDialog extends BaseDialog {
    ...
    static ObjectSet<String> bannedItems =
            ObjectSet.with("google-play", "itch.io", "dev-builds", "f-droid");
        ...
        for (LinkEntry link : Links.getLinks()) {
            ...
            table.table(
                            img -> {
                                ...
                                img.image()
                                        .height(5)
                                        .width(40f)
                                        .color(link.color.cpy().mul(0.8f, 0.8f, 0.8f, 1f));
                            })
                    .expandY();
            ...
            table.table(
                            inset -> {
                                ...
                                inset.row();
                                inset.labelWrap(link.description)
                                        .width(w - 100f)
