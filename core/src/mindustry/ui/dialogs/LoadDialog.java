...
public class LoadDialog extends BaseDialog {
    ...
    public void rebuild() {
        ...
        for (SaveSlot slot : array) {
            if (slot.isHidden()
                    || (searchString != null
                    && !Strings.stripColors(slot.getName())
                    .toLowerCase()
            ...
            button.left()
                    .add(new BorderImage(def, 4f))
                    .update(
                            im -> {
                                TextureRegionDrawable draw =
                                        (TextureRegionDrawable) im.getDrawable();
