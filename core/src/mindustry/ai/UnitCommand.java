...
/**
 * Defines a pattern of behavior that an RTS-controlled unit should follow. Shows up in the command
 * UI.
 */
public class UnitCommand {
    ...
    /**
     * Controller that this unit will use when this command is used. Return null for "default"
     * behavior.
     */
