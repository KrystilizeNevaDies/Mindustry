...
public class Blocks {
    ...
    berylliumWall,
            ...
            scrapWallHuge,
            scrapWallGigantic,
            thruster, // ok, these names are getting ridiculous, but at least I don't have humongous
    // walls
    // yet
    ...
    public static void load() {
        ...
        darksandTaintedWater =
                new ShallowLiquid("darksand-tainted-water") {
                    {
        ...
        darksandWater =
                new ShallowLiquid("darksand-water") {
                    {
                        speedMultiplier = 0.8f;
                        statusDuration = 50f;
                        albedo = 0.9f;
        ...
        yellowStoneVent =
                new SteamVent("yellow-stone-vent") {
                    {
        ...
        sporeWall =
                new StaticWall("spore-wall") {
                    {
                        taintedWater.asFloor().wall =
                                deepTaintedWater.asFloor().wall = sporeMoss.asFloor().wall = this;
                    }
                };
        ...
        duneWall =
                new StaticWall("dune-wall") {
                    {
                        basalt.asFloor().wall =
                                darksandWater.asFloor().wall =
                                        darksandTaintedWater.asFloor().wall = this;
                        attributes.set(Attribute.sand, 2f);
                    }
                };

        regolithWall =
                new StaticWall("regolith-wall") {
                    {
        ...
        yellowStoneWall =
                new StaticWall("yellow-stone-wall") {
                    {
                        yellowStone.asFloor().wall =
                                slag.asFloor().wall = yellowStonePlates.asFloor().wall = this;
                        attributes.set(Attribute.sand, 1.5f);
                    }
                };

        rhyoliteWall =
                new StaticWall("rhyolite-wall") {
                    {
                        rhyolite.asFloor().wall =
                                rhyoliteCrater.asFloor().wall = roughRhyolite.asFloor().wall = this;
                        attributes.set(Attribute.sand, 1f);
                    }
                };

        carbonWall =
                new StaticWall("carbon-wall") {
                    {
        ...
        ferricStoneWall =
                new StaticWall("ferric-stone-wall") {
                    {
        ...
        beryllicStoneWall =
                new StaticWall("beryllic-stone-wall") {
                    {
        ...
        crystallineStoneWall =
                new StaticWall("crystalline-stone-wall") {
                    {
                        variants = 4;
        ...
        redDiamondWall =
                new StaticTree("red-diamond-wall") {
                    {
                        variants = 3;
                    }
                };
        ...
        sandWall =
                new StaticWall("sand-wall") {
                    {
                        sandWater.asFloor().wall =
                                water.asFloor().wall = deepwater.asFloor().wall = this;
                        attributes.set(Attribute.sand, 2f);
                    }
                };
        ...
        boulder =
                new Prop("boulder") {
                    {
                        variants = 2;
                        stone.asFloor().decoration =
                                craters.asFloor().decoration = charr.asFloor().decoration = this;
                    }
                };

        snowBoulder =
                new Prop("snow-boulder") {
                    {
                        variants = 2;
                        snow.asFloor().decoration =
                                ice.asFloor().decoration =
                                        iceSnow.asFloor().decoration =
                                                salt.asFloor().decoration = this;
                    }
                };

        shaleBoulder =
                new Prop("shale-boulder") {
                    {
                        variants = 2;
        ...
        basaltBoulder =
                new Prop("basalt-boulder") {
                    {
                        variants = 2;
                        basalt.asFloor().decoration =
                                hotrock.asFloor().decoration =
                                        darksand.asFloor().decoration =
                                                magmarock.asFloor().decoration = this;
                    }
                };

        carbonBoulder =
                new Prop("carbon-boulder") {
                    {
                        variants = 2;
        ...
        ferricBoulder =
                new Prop("ferric-boulder") {
                    {
                        variants = 2;
                        ferricStone.asFloor().decoration =
                                ferricCraters.asFloor().decoration = this;
                    }
                };

        beryllicBoulder =
                new Prop("beryllic-boulder") {
                    {
                        variants = 2;
        ...
        yellowStoneBoulder =
                new Prop("yellow-stone-boulder") {
                    {
                        variants = 2;
                        yellowStone.asFloor().decoration =
                                regolith.asFloor().decoration =
                                        yellowStonePlates.asFloor().decoration = this;
                    }
                };

        // 1px outline + 4.50 gaussian shadow in gimp
        arkyicBoulder =
                new Prop("arkyic-boulder") {
                    {
                        variants = 3;
                        customShadow = true;
        ...
        vibrantCrystalCluster =
                new TallBlock("vibrant-crystal-cluster") {
                    {
                        variants = 3;
                        clipSize = 128f;
                    }
        ...
        wallOreThorium =
                new OreBlock("ore-wall-thorium", Items.thorium) {
                    {
                        wallOre = true;
                    }
                };
        ...
        wallOreBeryllium =
                new OreBlock("ore-wall-beryllium", Items.beryllium) {
                    {
                        wallOre = true;
                    }
                };
        ...
        wallOreTungsten =
                new OreBlock("ore-wall-tungsten", Items.tungsten) {
                    {
                        wallOre = true;
                    }
                };
        ...
        graphitePress =
                new GenericCrafter("graphite-press") {
                    {
        ...
        multiPress =
                new GenericCrafter("multi-press") {
                    {
                        requirements(
                                Category.crafting,
                                with(
        ...
        siliconCrucible =
                new AttributeCrafter("silicon-crucible") {
                    {
                        requirements(
                                Category.crafting,
                                with(
        ...
        kiln =
                new GenericCrafter("kiln") {
                    {
                        requirements(
                                Category.crafting,
                                with(Items.copper, 60, Items.graphite, 30, Items.lead, 30));
                        craftEffect = Fx.smeltsmoke;
        ...
        plastaniumCompressor =
                new GenericCrafter("plastanium-compressor") {
                    {
                        requirements(
                                Category.crafting,
                                with(
        ...
        phaseWeaver =
                new GenericCrafter("phase-weaver") {
                    {
                        requirements(
                                Category.crafting,
                                with(Items.silicon, 130, Items.lead, 120, Items.thorium, 75));
                        craftEffect = Fx.smeltsmoke;
        ...
        surgeSmelter =
                new GenericCrafter("surge-smelter") {
                    {
                        requirements(
                                Category.crafting,
                                with(Items.silicon, 80, Items.lead, 80, Items.thorium, 70));
                        craftEffect = Fx.smeltsmoke;
        ...
        cryofluidMixer =
                new GenericCrafter("cryofluid-mixer") {
                    {
                        requirements(
                                Category.crafting,
                                with(Items.lead, 65, Items.silicon, 40, Items.titanium, 60));
        ...
        pyratiteMixer =
                new GenericCrafter("pyratite-mixer") {
                    {
        ...
        blastMixer =
                new GenericCrafter("blast-mixer") {
                    {
        ...
        melter =
                new GenericCrafter("melter") {
                    {
                        requirements(
                                Category.crafting,
                                with(Items.copper, 30, Items.lead, 35, Items.graphite, 45));
                        health = 200;
        ...
        sporePress =
                new GenericCrafter("spore-press") {
                    {
        ...
        coalCentrifuge =
                new GenericCrafter("coal-centrifuge") {
                    {
                        requirements(
                                Category.crafting,
                                with(Items.titanium, 20, Items.graphite, 40, Items.lead, 30));
        ...
        siliconArcFurnace =
                new GenericCrafter("silicon-arc-furnace") {
                    {
                        requirements(
                                Category.crafting, with(Items.beryllium, 70, Items.graphite, 80));
                        craftEffect = Fx.none;
        ...
        electrolyzer =
                new GenericCrafter("electrolyzer") {
                    {
                        requirements(
                                Category.crafting,
                                with(
                        ...
                        regionRotated1 = 3;
                        outputLiquids =
                                LiquidStack.with(Liquids.ozone, 4f / 60, Liquids.hydrogen, 6f / 60);
                        liquidOutputDirections = new int[]{1, 3};
                    }
                };

        atmosphericConcentrator =
                new HeatCrafter("atmospheric-concentrator") {
                    {
                        requirements(
                                Category.crafting,
                                with(Items.oxide, 60, Items.beryllium, 180, Items.silicon, 150));
                        size = 3;
                        hasLiquids = true;
        ...
        oxidationChamber =
                new HeatProducer("oxidation-chamber") {
                    {
                        requirements(
                                Category.crafting,
                                with(
        ...
        electricHeater =
                new HeatProducer("electric-heater") {
                    {
        ...
        slagHeater =
                new HeatProducer("slag-heater") {
                    {
                        requirements(
                                Category.crafting,
                                with(Items.tungsten, 50, Items.oxide, 20, Items.beryllium, 20));
        ...
        phaseHeater =
                new HeatProducer("phase-heater") {
                    {
                        requirements(
                                Category.crafting,
                                with(Items.oxide, 30, Items.carbide, 30, Items.beryllium, 30));
        ...
        heatRedirector =
                new HeatConductor("heat-redirector") {
                    {
                        requirements(
                                Category.crafting, with(Items.tungsten, 10, Items.graphite, 10));
        ...
        slagIncinerator =
                new ItemIncinerator("slag-incinerator") {
                    {
        ...
        carbideCrucible =
                new HeatCrafter("carbide-crucible") {
                    {
                        requirements(
                                Category.crafting,
                                with(Items.tungsten, 110, Items.thorium, 150, Items.oxide, 60));
                        craftEffect = Fx.none;
        ...
        slagCentrifuge =
                new GenericCrafter("slag-centrifuge") {
                    {
                        requirements(
                                Category.crafting,
        ...
        surgeCrucible =
                new HeatCrafter("surge-crucible") {
                    {
                        requirements(
                                Category.crafting,
                                with(
        ...
        cyanogenSynthesizer =
                new HeatCrafter("cyanogen-synthesizer") {
                    {
                        // TODO requirements
                        requirements(
                                Category.crafting,
                                with(Items.carbide, 50, Items.silicon, 80, Items.beryllium, 90));
        ...
        phaseSynthesizer =
                new HeatCrafter("phase-synthesizer") {
                    {
                        requirements(
                                Category.crafting,
                                with(
        ...
        titaniumWallLarge =
                new Wall("titanium-wall-large") {
                    {
                        requirements(
                                Category.defense, ItemStack.mult(titaniumWall.requirements, 4));
        ...
        plastaniumWall =
                new Wall("plastanium-wall") {
                    {
                        requirements(
                                Category.defense, with(Items.plastanium, 5, Items.metaglass, 2));
        ...
        plastaniumWallLarge =
                new Wall("plastanium-wall-large") {
                    {
                        requirements(
                                Category.defense, ItemStack.mult(plastaniumWall.requirements, 4));
        ...
        scrapWallLarge =
                new Wall("scrap-wall-large") {
                    {
                        requirements(
                                Category.defense,
                                BuildVisibility.sandboxOnly,
                                ItemStack.mult(scrapWall.requirements, 4));
        ...
        scrapWallHuge =
                new Wall("scrap-wall-huge") {
                    {
                        requirements(
                                Category.defense,
                                BuildVisibility.sandboxOnly,
                                ItemStack.mult(scrapWall.requirements, 9));
        ...
        scrapWallGigantic =
                new Wall("scrap-wall-gigantic") {
                    {
                        requirements(
                                Category.defense,
                                BuildVisibility.sandboxOnly,
                                ItemStack.mult(scrapWall.requirements, 16));
        ...
        berylliumWallLarge =
                new Wall("beryllium-wall-large") {
                    {
                        requirements(
                                Category.defense, ItemStack.mult(berylliumWall.requirements, 4));
        ...
        tungstenWallLarge =
                new Wall("tungsten-wall-large") {
                    {
                        requirements(
                                Category.defense, ItemStack.mult(tungstenWall.requirements, 4));
        ...
        reinforcedSurgeWall =
                new Wall("reinforced-surge-wall") {
                    {
                        requirements(
                                Category.defense, with(Items.surgeAlloy, 6, Items.tungsten, 2));
        ...
        reinforcedSurgeWallLarge =
                new Wall("reinforced-surge-wall-large") {
                    {
                        requirements(
                                Category.defense,
                                ItemStack.mult(reinforcedSurgeWall.requirements, 4));
        ...
        mendProjector =
                new MendProjector("mend-projector") {
                    {
                        requirements(
                                Category.effect,
                                with(
        ...
        overdriveProjector =
                new OverdriveProjector("overdrive-projector") {
                    {
                        requirements(
                                Category.effect,
                                with(
        ...
        overdriveDome =
                new OverdriveProjector("overdrive-dome") {
                    {
                        requirements(
                                Category.effect,
                                with(
        ...
        forceProjector =
                new ForceProjector("force-projector") {
                    {
                        requirements(
                                Category.effect,
                                with(Items.lead, 100, Items.titanium, 75, Items.silicon, 125));
                        size = 3;
        ...
        buildTower =
                new BuildTurret("build-tower") {
                    {
                        requirements(
                                Category.effect,
                                with(Items.silicon, 150, Items.oxide, 40, Items.thorium, 60));
        ...
        regenProjector =
                new RegenProjector("regen-projector") {
                    {
                        requirements(
                                Category.effect,
                                with(
                    ...
                    new DirectionalForceProjector("barrier-projector") {
                        {
                            requirements(
                                    Category.effect,
                                    with(Items.surgeAlloy, 100, Items.silicon, 125));
                            size = 3;
                            width = 50f;
                            length = 36;
                            shieldHealth = 2000f;
        ...
        shockwaveTower =
                new ShockwaveTower("shockwave-tower") {
                    {
                        requirements(
                                Category.effect,
                                with(
        ...
        // TODO 5x5??
        shieldProjector =
                new BaseShield("shield-projector") {
                    {
        ...
        largeShieldProjector =
                new BaseShield("large-shield-projector") {
                    {
                        requirements(Category.effect, BuildVisibility.editorOnly, with());
        ...
        shieldBreaker =
                new ShieldBreaker("shield-breaker") {
                    {
                        requirements(Category.effect, BuildVisibility.editorOnly, with());

                        size = 5;
                        toDestroy =
                                new Block[]{Blocks.shieldProjector, Blocks.largeShieldProjector};
        ...
        titaniumConveyor =
                new Conveyor("titanium-conveyor") {
                    {
                        requirements(
                                Category.distribution,
                                with(Items.copper, 1, Items.lead, 1, Items.titanium, 1));
                        health = 65;
                        speed = 0.08f;
                        displayedSpeed = 11f;
                    }
        ...
        plastaniumConveyor =
                new StackConveyor("plastanium-conveyor") {
                    {
                        requirements(
                                Category.distribution,
                                with(Items.plastanium, 1, Items.silicon, 1, Items.graphite, 1));
                        health = 75;
                        speed = 4f / 60f;
                        itemCapacity = 10;
                    }
        ...
        armoredConveyor =
                new ArmoredConveyor("armored-conveyor") {
                    {
                        requirements(
                                Category.distribution,
                                with(Items.plastanium, 1, Items.thorium, 1, Items.metaglass, 1));
                        health = 180;
                        speed = 0.08f;
                        displayedSpeed = 11f;
                    }
        ...
        itemBridge =
                new BufferedItemBridge("bridge-conveyor") {
                    {
        ...
        overflowGate =
                new OverflowGate("overflow-gate") {
                    {
        ...
        underflowGate =
                new OverflowGate("underflow-gate") {
                    {
                        requirements(Category.distribution, with(Items.lead, 2, Items.copper, 4));
                        buildCostMultiplier = 3f;
                        invert = true;
        ...
        armoredDuct =
                new Duct("armored-duct") {
                    {
                        requirements(
                                Category.distribution, with(Items.beryllium, 2, Items.tungsten, 1));
                        health = 140;
                        speed = 4f;
                        armored = true;
        ...
        overflowDuct =
                new OverflowDuct("overflow-duct") {
                    {
                        requirements(
        ...
        underflowDuct =
                new OverflowDuct("underflow-duct") {
                    {
                        requirements(
                                Category.distribution, with(Items.graphite, 8, Items.beryllium, 8));
                        health = 90;
                ...
                new DirectionalUnloader("duct-unloader") {
                    {
                        requirements(
                                Category.distribution,
                                with(Items.graphite, 20, Items.silicon, 20, Items.tungsten, 10));
                        health = 120;
                        speed = 4f;
                        solid = false;
                        underBullets = true;
        ...
        surgeConveyor =
                new StackConveyor("surge-conveyor") {
                    {
                        requirements(
                                Category.distribution,
                                with(Items.surgeAlloy, 1, Items.tungsten, 1));
                        health = 130;
        ...
        surgeRouter =
                new StackRouter("surge-router") {
                    {
                        requirements(
                                Category.distribution,
                                with(Items.surgeAlloy, 5, Items.tungsten, 1));
                        health = 130;
        ...
        unitCargoLoader =
                new UnitCargoLoader("unit-cargo-loader") {
                    {
                        requirements(
                                Category.distribution,
                                with(Items.silicon, 80, Items.surgeAlloy, 50, Items.oxide, 20));
        ...
        unitCargoUnloadPoint =
                new UnitCargoUnloadPoint("unit-cargo-unload-point") {
                    {
                        requirements(
                                Category.distribution, with(Items.silicon, 60, Items.tungsten, 60));
        ...
        platedConduit =
                new ArmoredConduit("plated-conduit") {
                    {
                        requirements(
                                Category.liquid,
                                with(Items.thorium, 2, Items.metaglass, 1, Items.plastanium, 1));
                        liquidCapacity = 16f;
                        liquidPressure = 1.025f;
                        health = 220;
                    }
        ...
        liquidRouter =
                new LiquidRouter("liquid-router") {
                    {
        ...
        liquidContainer =
                new LiquidRouter("liquid-container") {
                    {
                        requirements(
                                Category.liquid, with(Items.titanium, 10, Items.metaglass, 15));
                        liquidCapacity = 700f;
                        size = 2;
                    }
                };
        ...
        liquidTank =
                new LiquidRouter("liquid-tank") {
                    {
                        requirements(
                                Category.liquid, with(Items.titanium, 30, Items.metaglass, 40));
                        size = 3;
        ...
        bridgeConduit =
                new LiquidBridge("bridge-conduit") {
                    {
                        requirements(Category.liquid, with(Items.graphite, 4, Items.metaglass, 8));
                        fadeIn = moveArrows = false;
                        arrowSpacing = 6f;
        ...
        phaseConduit =
                new LiquidBridge("phase-conduit") {
                    {
                        requirements(
                                Category.liquid,
                                with(
        ...
        // TODO different name
        reinforcedPump =
                new Pump("reinforced-pump") {
                    {
                        requirements(
                                Category.liquid,
                                with(Items.beryllium, 40, Items.tungsten, 30, Items.silicon, 20));
        ...
        reinforcedConduit =
                new ArmoredConduit("reinforced-conduit") {
                    {
        ...
        // TODO make it leak
        reinforcedLiquidJunction =
                new LiquidJunction("reinforced-liquid-junction") {
                    {
        ...
        reinforcedBridgeConduit =
                new DirectionLiquidBridge("reinforced-bridge-conduit") {
                    {
        ...
        reinforcedLiquidRouter =
                new LiquidRouter("reinforced-liquid-router") {
                    {
        ...
        reinforcedLiquidContainer =
                new LiquidRouter("reinforced-liquid-container") {
                    {
                        requirements(
                                Category.liquid, with(Items.tungsten, 10, Items.beryllium, 16));
        ...
        reinforcedLiquidTank =
                new LiquidRouter("reinforced-liquid-tank") {
                    {
                        requirements(
                                Category.liquid, with(Items.tungsten, 40, Items.beryllium, 50));
                        size = 3;
                        solid = true;
        ...
        powerNodeLarge =
                new PowerNode("power-node-large") {
                    {
                        requirements(
                                Category.power,
                                with(Items.titanium, 5, Items.lead, 10, Items.silicon, 3));
                        size = 2;
                        maxNodes = 15;
                        laserRange = 15f;
                    }
        ...
        diode =
                new PowerDiode("diode") {
                    {
                        requirements(
                                Category.power,
                                with(Items.silicon, 10, Items.plastanium, 5, Items.metaglass, 10));
                    }
                };
        ...
        batteryLarge =
                new Battery("battery-large") {
                    {
                        requirements(
                                Category.power,
                                with(Items.titanium, 20, Items.lead, 50, Items.silicon, 30));
                        size = 3;
        ...
        thermalGenerator =
                new ThermalGenerator("thermal-generator") {
                    {
                        requirements(
                                Category.power,
                                with(
        ...
        differentialGenerator =
                new ConsumeGenerator("differential-generator") {
                    {
                        requirements(
                                Category.power,
                                with(
        ...
        rtgGenerator =
                new ConsumeGenerator("rtg-generator") {
                    {
                        requirements(
                                Category.power,
                                with(
        ...
        solarPanel =
                new SolarGenerator("solar-panel") {
                    {
        ...
        largeSolarPanel =
                new SolarGenerator("solar-panel-large") {
                    {
                        requirements(
                                Category.power,
                                with(Items.lead, 80, Items.silicon, 110, Items.phaseFabric, 15));
                        size = 3;
        ...
        thoriumReactor =
                new NuclearReactor("thorium-reactor") {
                    {
                        requirements(
                                Category.power,
                                with(
        ...
        impactReactor =
                new ImpactReactor("impact-reactor") {
                    {
                        requirements(
                                Category.power,
                                with(
        ...
        // TODO requirements
        beamTower =
                new BeamNode("beam-tower") {
                    {
                        requirements(
                                Category.power,
                                with(Items.beryllium, 30, Items.oxide, 20, Items.silicon, 10));
                        size = 3;
                        consumesPower = outputsPower = true;
        ...
        turbineCondenser =
                new ThermalGenerator("turbine-condenser") {
                    {
        ...
        chemicalCombustionChamber =
                new ConsumeGenerator("chemical-combustion-chamber") {
                    {
                        requirements(
                                Category.power,
                                with(
                        ...
                        consumeLiquids(
                                LiquidStack.with(
                                        Liquids.ozone, 2f / 60f, Liquids.arkycite, 40f / 60f));
                        size = 3;
                        drawer =
                                new DrawMulti(
                                        new DrawRegion("-bottom"),
        ...
        pyrolysisGenerator =
                new ConsumeGenerator("pyrolysis-generator") {
                    {
                        requirements(
                                Category.power,
                                with(
                        ...
                        consumeLiquids(
                                LiquidStack.with(
                                        Liquids.slag, 20f / 60f, Liquids.arkycite, 30f / 60f));
                        size = 3;
        ...
        fluxReactor =
                new VariableReactor("flux-reactor") {
                    {
                        requirements(
                                Category.power,
                                with(
        ...
        // TODO stats
        neoplasiaReactor =
                new HeaterGenerator("neoplasia-reactor") {
                    {
                        requirements(
                                Category.power,
                                with(
                        ...
                        explodeEffect =
                                new MultiEffect(
                                        Fx.bigShockwave,
                                        new WrapEffect(Fx.titanSmoke, Liquids.neoplasm.color),
                                        Fx.neoplasmSplat);
        ...
        pneumaticDrill =
                new Drill("pneumatic-drill") {
                    {
                        requirements(
                                Category.production, with(Items.copper, 18, Items.graphite, 10));
                        tier = 3;
                        drillTime = 400;
                        size = 2;
        ...
        cultivator =
                new AttributeCrafter("cultivator") {
                    {
                        requirements(
                                Category.production,
                                with(Items.copper, 25, Items.lead, 25, Items.silicon, 10));
        ...
        // TODO output heat?
        ventCondenser =
                new AttributeCrafter("vent-condenser") {
                    {
                        requirements(
                                Category.production, with(Items.graphite, 20, Items.beryllium, 60));
                        attribute = Attribute.steam;
                        minEfficiency = 9f - 0.0001f;
                        baseEfficiency = 0f;
                        displayEfficiency = false;
                        ...
                        drawer =
                                new DrawMulti(
                                        ...
                                        new DrawRegion("-mid"),
                                        new DrawLiquidTile(Liquids.water, 38f / 4f),
                                        new DrawDefault());
                        craftTime = 120f;
                        size = 3;
                        ambientSound = Sounds.hum;
        ...
        cliffCrusher =
                new WallCrafter("cliff-crusher") {
                    {
                        requirements(
                                Category.production, with(Items.graphite, 25, Items.beryllium, 20));
        ...
        // TODO awful name
        largePlasmaBore =
                new BeamDrill("large-plasma-bore") {
                    {
                        // TODO requirements
                        requirements(
                                Category.production,
        ...
        impactDrill =
                new BurstDrill("impact-drill") {
                    {
                        requirements(
                                Category.production,
                                with(Items.silicon, 70, Items.beryllium, 90, Items.graphite, 60));
                        drillTime = 60f * 12f;
                        size = 4;
                        hasPower = true;
                        tier = 6;
                        drillEffect =
                                new MultiEffect(
                                        Fx.mineImpact,
                                        Fx.drillSteam,
                                        Fx.mineImpactWave.wrap(Pal.redLight, 40f));
                        shake = 4f;
                        itemCapacity = 40;
        ...
        coreShard =
                new CoreBlock("core-shard") {
                    {
                        requirements(
                                Category.effect,
                                BuildVisibility.editorOnly,
                                with(Items.copper, 1000, Items.lead, 800));
                        alwaysUnlocked = true;
        ...
        coreFoundation =
                new CoreBlock("core-foundation") {
                    {
                        requirements(
                                Category.effect,
                                with(Items.copper, 3000, Items.lead, 3000, Items.silicon, 2000));
        ...
        vault =
                new StorageBlock("vault") {
                    {
                        requirements(
                                Category.effect, with(Items.titanium, 250, Items.thorium, 125));
                        size = 3;
                        itemCapacity = 1000;
                        scaledHealth = 55;
                    }
        ...
        reinforcedContainer =
                new StorageBlock("reinforced-container") {
                    {
        ...
        reinforcedVault =
                new StorageBlock("reinforced-vault") {
                    {
                        requirements(
                                Category.effect,
                                with(Items.tungsten, 125, Items.thorium, 70, Items.beryllium, 100));
                        size = 3;
                        itemCapacity = 900;
                        scaledHealth = 120;
                        coreMerge = false;
        ...
        wave =
                new LiquidTurret("wave") {
                    {
                        requirements(
                                Category.turret,
                                with(Items.metaglass, 45, Items.lead, 75, Items.copper, 25));
                        ammo(
                                Liquids.water,
                                ...
                                Liquids.cryofluid,
                                new LiquidBulletType(Liquids.cryofluid) {
                                    {
                                        drag = 0.01f;
                                    }
                                },
        ...
        parallax =
                new TractorBeamTurret("parallax") {
                    {
                        requirements(
                                Category.turret,
                                with(Items.silicon, 120, Items.titanium, 90, Items.graphite, 30));
        ...
        salvo =
                new ItemTurret("salvo") {
                    {
                        requirements(
                                Category.turret,
                                with(Items.copper, 100, Items.graphite, 80, Items.titanium, 50));
                        ammo(
                                Items.copper,
                                new BasicBulletType(2.5f, 11) {
                                    {
                                        width = 7f;
                                        height = 9f;
                                        lifetime = 60f;
                                ...
                                Items.silicon,
                                new BasicBulletType(3f, 15, "bullet") {
                                    {
                                        width = 7f;
                                        height = 9f;
                                        homingPower = 0.1f;
                                ...
                                Items.thorium,
                                new BasicBulletType(4f, 29, "bullet") {
                                    {
                                        width = 10f;
                                        height = 13f;
        ...
        segment =
                new PointDefenseTurret("segment") {
                    {
                        requirements(
                                Category.turret,
                                with(
                ...
                new ItemTurret("fuse") {
                    {
                        requirements(
                                Category.turret,
                                with(Items.copper, 225, Items.graphite, 225, Items.thorium, 100));
        ...
        ripple =
                new ItemTurret("ripple") {
                    {
                        requirements(
                                Category.turret,
                                with(Items.copper, 150, Items.graphite, 135, Items.titanium, 60));
                        ammo(
                                Items.graphite,
                                new ArtilleryBulletType(3f, 20) {
                                    {
                                ...
                                Items.blastCompound,
                                new ArtilleryBulletType(2f, 20, "shell") {
                                    {
                                        hitEffect = Fx.blastExplosion;
                                        knockback = 0.8f;
                                        lifetime = 80f;
                                ...
                                Items.plastanium,
                                new ArtilleryBulletType(3.4f, 20, "shell") {
                                    {
                                        ...
                                        splashDamage = 45f;
                                        fragBullet =
                                                new BasicBulletType(2.5f, 10, "bullet") {
                                                    {
                                                        width = 10f;
                                                        height = 12f;
                                                        shrinkY = 1f;
        ...
        cyclone =
                new ItemTurret("cyclone") {
                    {
                        requirements(
                                Category.turret,
                                with(Items.copper, 200, Items.titanium, 125, Items.plastanium, 80));
                        ammo(
                                Items.metaglass,
                                new FlakBulletType(4f, 9) {
                                    {
                                        ammoMultiplier = 3f;
                                        shootEffect = Fx.shootSmall;
                                        reloadMultiplier = 0.8f;
                                        ...
                                        splashDamageRadius = 25f;
                                        fragBullet =
                                                new BasicBulletType(3f, 8, "bullet") {
                                                    {
                                                        width = 5f;
                                                        height = 12f;
                                                        shrinkY = 1f;
                                ...
                                Items.plastanium,
                                new FlakBulletType(4f, 6) {
                                    {
                                        splashDamageRadius = 40f;
                                        splashDamage = 25f * 1.5f;
                                        fragBullet =
                                                new BasicBulletType(2.5f, 12, "bullet") {
                                                    {
                                                        width = 10f;
                                                        height = 12f;
                                                        shrinkY = 1f;
                ...
                new LaserTurret("meltdown") {
                    {
                        ...
                        shootType =
                                new ContinuousLaserBulletType(78) {
                                    {
                                        length = 200f;
                                ...
                                new BasicBulletType(8f, 165) {
                                    {
                                        ...
                                        pierceBuilding = true;
                                        hitColor =
                                                backColor = trailColor = Pal.tungstenShot;
                                        frontColor = Color.white;
                                        trailWidth = 2.2f;
                                        trailLength = 11;
                                        hitEffect = despawnEffect = Fx.hitBulletColor;
        ...
        sublimate =
                new ContinuousLiquidTurret("sublimate") {
                    {
                        requirements(
                                Category.turret,
                                with(
                        ...
                        // TODO balance, set up, where is liquid/sec displayed? status effects
                        // maybe?
                        ammo(
                                Liquids.ozone,
        ...
        titan =
                new ItemTurret("titan") {
                    {
                        requirements(
                                Category.turret,
                                with(Items.tungsten, 250, Items.silicon, 300, Items.thorium, 400));

                        ammo(
                                // TODO 1 more ammo type, decide on base type
                                Items.thorium,
                                new ArtilleryBulletType(2.5f, 310, "shell") {
                                    {
                                        hitEffect =
                                                new MultiEffect(Fx.titanExplosion, Fx.titanSmoke);
                                        despawnEffect = Fx.none;
                                        knockback = 2f;
                                        lifetime = 140f;
                                        height = 19f;
                ...
                new ContinuousTurret("lustre") {
                    {
                        ...
                        drawer =
                                new DrawTurret("reinforced-") {
                                    {
                                        var heatp =
                                                PartProgress.warmup.blend(
                                                        p -> Mathf.absin(2f, 1f) * p.warmup, 0.2f);
                                ...
                                new BasicBulletType(0f, 1) {
                                    {
                                        ...
                                        spawnUnit =
                                                new MissileUnitType("scathe-missile") {
                                                    {
                                                        speed = 4.6f;
                                                        maxRange = 6f;
                                                        lifetime = 60f * 5.5f;
                                ...
                                new DrawTurret("reinforced-") {
                                    {
                                        parts.addAll(
                                                new RegionPart("-mid") {
                                                    {
                                                        heatProgress =
                                                                PartProgress.heat.blend(
                                                                        PartProgress.warmup, 0.5f);
                                                        mirror = false;
                                                    }
                                                },
                                                new RegionPart("-blade") {
                                ...
                                new FlakBulletType(8f, 80f) {
                                    {
                                        ...
                                        hitColor =
                                                backColor =
                                                        trailColor = lightningColor = circleColor;
                                        frontColor = Color.white;
                                        trailWidth = 3f;
                                        trailLength = 12;
                                        hitEffect = despawnEffect = Fx.hitBulletColor;
                                        ...
                                        fragBullet =
                                                new LaserBulletType(90f) {
                                                    {
                                                        colors =
                                                                new Color[]{
                                                                        haloColor.cpy().a(0.4f),
                                                                        haloColor,
                                                                        Color.white
                                                                };
                                                        buildingDamageMultiplier = 0.25f;
                                ...
                                new DrawTurret("reinforced-") {
                                    {
                                        ...
                                        Color heatCol2 =
                                                heatCol.cpy().add(0.1f, 0.1f, 0.1f).mul(1.2f);
                                        for (int i = 1; i < 4; i++) {
                                            int fi = i;
                                            parts.add(
                                                    new RegionPart("-spine") {
        ...
        groundFactory =
                new UnitFactory("ground-factory") {
                    {
                        requirements(
                                Category.units,
                                with(Items.copper, 50, Items.lead, 120, Items.silicon, 80));
                        plans =
                                Seq.with(
                                        new UnitPlan(
                                                UnitTypes.dagger,
                                        ...
                                        new UnitPlan(
                                                UnitTypes.crawler,
                                                60f * 10,
                                                with(Items.silicon, 8, Items.coal, 10)),
                                        new UnitPlan(
                                                UnitTypes.nova,
                                                60f * 40,
                                                with(
        ...
        airFactory =
                new UnitFactory("air-factory") {
                    {
                        requirements(Category.units, with(Items.copper, 60, Items.lead, 70));
                        plans =
                                Seq.with(
                                        new UnitPlan(
                                                UnitTypes.flare, 60f * 15, with(Items.silicon, 15)),
                                        new UnitPlan(
                                                UnitTypes.mono,
                                                60f * 35,
                                                with(Items.silicon, 30, Items.lead, 15)));
                        size = 3;
                        consumePower(1.2f);
                    }
                };
        ...
        navalFactory =
                new UnitFactory("naval-factory") {
                    {
                        requirements(
                                Category.units,
                                with(Items.copper, 150, Items.lead, 130, Items.metaglass, 120));
                        plans =
                                Seq.with(
                                        new UnitPlan(
                                                UnitTypes.risso,
                                                60f * 45f,
                                                with(Items.silicon, 20, Items.metaglass, 35)),
                                        new UnitPlan(
                                                UnitTypes.retusa,
                                                60f * 50f,
                                                with(
        ...
        additiveReconstructor =
                new Reconstructor("additive-reconstructor") {
                    {
                        requirements(
                                Category.units,
                                with(Items.copper, 200, Items.lead, 120, Items.silicon, 90));
        ...
        multiplicativeReconstructor =
                new Reconstructor("multiplicative-reconstructor") {
                    {
                        requirements(
                                Category.units,
                                with(
                        ...
                        consumePower(6f);
                        consumeItems(
                                with(Items.silicon, 130, Items.titanium, 80, Items.metaglass, 40));
        ...
        exponentialReconstructor =
                new Reconstructor("exponential-reconstructor") {
                    {
                        requirements(
                                Category.units,
                                with(
        ...
        tetrativeReconstructor =
                new Reconstructor("tetrative-reconstructor") {
                    {
                        requirements(
                                Category.units,
                                with(
        ...
        repairPoint =
                new RepairTurret("repair-point") {
                    {
                        requirements(
                                Category.units,
                                with(Items.lead, 30, Items.copper, 30, Items.silicon, 20));
                        repairSpeed = 0.45f;
                        repairRadius = 60f;
                        beamWidth = 0.73f;
                        powerUse = 1f;
        ...
        repairTurret =
                new RepairTurret("repair-turret") {
                    {
                        requirements(
                                Category.units,
                                with(Items.silicon, 90, Items.thorium, 80, Items.plastanium, 60));
                        size = 2;
                        length = 6f;
                        repairSpeed = 3f;
                        repairRadius = 145f;
        ...
        tankFabricator =
                new UnitFactory("tank-fabricator") {
                    {
                        requirements(
                                Category.units, with(Items.silicon, 200, Items.beryllium, 150));
                        size = 3;
                        configurable = false;
                        plans.add(
                                new UnitPlan(
                                        UnitTypes.stell,
                                        60f * 35f,
                                        with(Items.beryllium, 40, Items.silicon, 50)));
                        researchCost =
                                with(Items.beryllium, 200, Items.graphite, 80, Items.silicon, 80);
                        regionSuffix = "-dark";
                        fogRadius = 3;
                        consumePower(2f);
                    }
        ...
        shipFabricator =
                new UnitFactory("ship-fabricator") {
                    {
                        requirements(
                                Category.units, with(Items.silicon, 250, Items.beryllium, 200));
                        ...
                        plans.add(
                                new UnitPlan(
                                        UnitTypes.elude,
                                        60f * 40f,
                                        with(Items.graphite, 50, Items.silicon, 70)));
                        regionSuffix = "-dark";
                        fogRadius = 3;
                        researchCostMultiplier = 0.5f;
                        consumePower(2f);
        ...
        mechFabricator =
                new UnitFactory("mech-fabricator") {
                    {
                        requirements(
                                Category.units,
                                with(Items.silicon, 200, Items.graphite, 300, Items.tungsten, 60));
                        size = 3;
                        configurable = false;
                        plans.add(
                                new UnitPlan(
                                        UnitTypes.merui,
                                        60f * 40f,
                                        with(Items.beryllium, 50, Items.silicon, 70)));
                        regionSuffix = "-dark";
                        fogRadius = 3;
        ...
        tankRefabricator =
                new Reconstructor("tank-refabricator") {
                    {
                        requirements(
                                Category.units,
                                with(Items.beryllium, 200, Items.tungsten, 80, Items.silicon, 100));
                        regionSuffix = "-dark";
                        ...
                        upgrades.addAll(new UnitType[]{UnitTypes.stell, UnitTypes.locus});
                    }
                };

        mechRefabricator =
                new Reconstructor("mech-refabricator") {
                    {
                        requirements(
                                Category.units,
                                with(
                        ...
                        upgrades.addAll(new UnitType[]{UnitTypes.merui, UnitTypes.cleroi});
                    }
                };

        shipRefabricator =
                new Reconstructor("ship-refabricator") {
                    {
                        requirements(
                                Category.units,
                                with(
                        ...
                        upgrades.addAll(new UnitType[]{UnitTypes.elude, UnitTypes.avert});
                    }
                };

        // yes very silly name
        primeRefabricator =
                new Reconstructor("prime-refabricator") {
                    {
                        requirements(
                                Category.units,
                                with(
                ...
                new UnitAssembler("tank-assembler") {
                    {
                        ...
                        plans.add(
                                new AssemblerUnitPlan(
                                        ...
                                        60f * 50f,
                                        PayloadStack.list(
                                                UnitTypes.stell, 4, Blocks.tungstenWallLarge, 10)),
                                new AssemblerUnitPlan(
                                        UnitTypes.conquer,
                                        60f * 60f * 3f,
                                        PayloadStack.list(
                                                UnitTypes.locus, 6, Blocks.carbideWallLarge, 20)));
                        areaSize = 13;
        ...
        // TODO requirements
        shipAssembler =
                new UnitAssembler("ship-assembler") {
                    {
                        requirements(
                                Category.units,
                                with(
                        ...
                        plans.add(
                                new AssemblerUnitPlan(
                                        ...
                                        60f * 60f,
                                        PayloadStack.list(
                                                UnitTypes.elude, 4, Blocks.berylliumWallLarge, 8)),
                                new AssemblerUnitPlan(
                                        UnitTypes.disrupt,
                                        60f * 60f * 3f,
                                        PayloadStack.list(
                                                UnitTypes.avert, 6, Blocks.carbideWallLarge, 20)));
                        areaSize = 13;
        ...
        // TODO requirements
        mechAssembler =
                new UnitAssembler("mech-assembler") {
                    {
                        requirements(
                                Category.units,
                                with(
                        ...
                        plans.add(
                                new AssemblerUnitPlan(
                                        ...
                                        60f * 60f,
                                        PayloadStack.list(
                                                UnitTypes.merui, 4, Blocks.tungstenWallLarge, 10)),
                                new AssemblerUnitPlan(
                                        UnitTypes.collaris,
                                        60f * 60f * 3f,
                                        PayloadStack.list(
                                                UnitTypes.cleroi, 6, Blocks.carbideWallLarge, 20)));
                        consumePower(3f);
                        areaSize = 13;
        ...
        basicAssemblerModule =
                new UnitAssemblerModule("basic-assembler-module") {
                    {
                        requirements(
                                Category.units,
                                with(
        ...
        unitRepairTower =
                new RepairTower("unit-repair-tower") {
                    {
                        requirements(
                                Category.units,
                                with(Items.graphite, 90, Items.silicon, 90, Items.tungsten, 80));
        ...
        payloadConveyor =
                new PayloadConveyor("payload-conveyor") {
                    {
        ...
        payloadRouter =
                new PayloadRouter("payload-router") {
                    {
        ...
        reinforcedPayloadConveyor =
                new PayloadConveyor("reinforced-payload-conveyor") {
                    {
        ...
        reinforcedPayloadRouter =
                new PayloadRouter("reinforced-payload-router") {
                    {
        ...
        payloadMassDriver =
                new PayloadMassDriver("payload-mass-driver") {
                    {
                        requirements(
                                Category.units,
                                with(Items.tungsten, 120, Items.silicon, 120, Items.graphite, 50));
                        regionSuffix = "-dark";
                        size = 3;
                        reload = 130f;
                        chargeTime = 90f;
        ...
        payloadPropulsionTower =
                new PayloadMassDriver("payload-propulsion-tower") {
                    {
                        requirements(
                                Category.units,
                                with(
        ...
        smallDeconstructor =
                new PayloadDeconstructor("small-deconstructor") {
                    {
                        requirements(
                                Category.units,
                                with(
        ...
        deconstructor =
                new PayloadDeconstructor("deconstructor") {
                    {
                        requirements(
                                Category.units,
                                with(
                ...
                new Constructor("constructor") {
                    {
                        requirements(
                                Category.units,
                                with(Items.silicon, 100, Items.beryllium, 150, Items.tungsten, 80));
                        regionSuffix = "-dark";
                        hasPower = true;
                        buildSpeed = 0.3f;
                        consumePower(2f);
        ...
        largeConstructor =
                new Constructor("large-constructor") {
                    {
                        requirements(
                                Category.units,
                                with(
        ...
        payloadLoader =
                new PayloadLoader("payload-loader") {
                    {
                        requirements(
                                Category.units,
                                with(Items.graphite, 50, Items.silicon, 50, Items.tungsten, 80));
                        regionSuffix = "-dark";
                        hasPower = true;
                        consumePower(2f);
                        size = 3;
        ...
        payloadUnloader =
                new PayloadUnloader("payload-unloader") {
                    {
                        requirements(
                                Category.units,
                                with(Items.graphite, 50, Items.silicon, 50, Items.tungsten, 30));
                        regionSuffix = "-dark";
                        hasPower = true;
                        consumePower(2f);
                        size = 3;
        ...
        interplanetaryAccelerator =
                new Accelerator("interplanetary-accelerator") {
                    {
                        requirements(
                                Category.effect,
        ...
        microProcessor =
                new LogicBlock("micro-processor") {
                    {
                        requirements(
                                Category.logic,
                                with(Items.copper, 90, Items.lead, 50, Items.silicon, 50));
        ...
        logicProcessor =
                new LogicBlock("logic-processor") {
                    {
                        requirements(
                                Category.logic,
                                with(
        ...
        hyperProcessor =
                new LogicBlock("hyper-processor") {
                    {
                        requirements(
                                Category.logic,
                                with(
        ...
        memoryCell =
                new MemoryBlock("memory-cell") {
                    {
                        requirements(
                                Category.logic,
                                with(Items.graphite, 30, Items.silicon, 30, Items.copper, 30));
        ...
        logicDisplay =
                new LogicDisplay("logic-display") {
                    {
                        requirements(
                                Category.logic,
                                with(Items.lead, 100, Items.silicon, 50, Items.metaglass, 50));
        ...
        largeLogicDisplay =
                new LogicDisplay("large-logic-display") {
                    {
                        requirements(
                                Category.logic,
                                with(
        ...
        canvas =
                new CanvasBlock("canvas") {
                    {
                        requirements(
                                Category.logic, BuildVisibility.debugOnly, with(Items.silicon, 50));
        ...
        worldProcessor =
                new LogicBlock("world-processor") {
                    {
