 ...
 * See {@link SerpuloTechTree#load} source for example usage.
 */
public class TechTree {
    ...
    public static TechNode nodeRoot(
            String name, UnlockableContent content, boolean requireUnlock, Runnable children) {
    ...
    public static TechNode node(
            UnlockableContent content, ItemStack[] requirements, Runnable children) {
    ...
    public static TechNode node(
            UnlockableContent content, Seq<Objective> objectives, Runnable children) {
    ...
    public static TechNode nodeProduce(
            UnlockableContent content, Seq<Objective> objectives, Runnable children) {
        return node(
                content,
                content.researchRequirements(),
    ...
    public static class TechNode {
        ...
        /**
         * For roots only. If true, this needs to be unlocked before it is selectable in the
         * research dialog. Does not apply when you are on the planet itself.
         */
        ...
        public TechNode(
                @Nullable TechNode parent, UnlockableContent content, ItemStack[] requirements) {
            if (parent != null) {
            ...
            if (researchCostMultipliers.size > 0) {
                ...
                for (ItemStack requirement : requirements) {
                    requirement.amount =
                            (int)
                                    (requirement.amount
                                            * researchCostMultipliers.get(requirement.item, 1));
                }
            }
