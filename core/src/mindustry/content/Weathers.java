...
public class Weathers {
    public static Weather rain, snow, sandstorm, sporestorm, fog, suspendParticles;

    public static void load() {
        snow =
                new ParticleWeather("snow") {
                    {
        ...
        sporestorm =
                new ParticleWeather("sporestorm") {
                    {
        ...
        suspendParticles =
                new ParticleWeather("suspend-particles") {
                    {
