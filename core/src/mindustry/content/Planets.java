...
public class Planets {
    public static Planet sun, erekir, tantros, serpulo, gier, notva, verilus;

    public static void load() {
        sun =
                new Planet("sun", null, 4f) {
                    {
                        bloom = true;
                        accessible = false;
    ...
    private static Planet makeAsteroid(
            String name,
            Planet parent,
            Block base,
            Block tint,
                                ...
                                meshes.add(
                                        new MatMesh(
                                                new NoiseMesh(
                                                        ...
                                                        j + 1,
                                                        1,
                                                        0.022f + rand.random(0.039f) * scale,
                                                        2,
                                                        0.6f,
                                                        0.38f,
                                                        20f,
