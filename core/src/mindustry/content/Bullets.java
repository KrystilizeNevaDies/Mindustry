...
/**
 * Class for holding special internal bullets. Formerly used to define preset bullets for turrets;
 * as of v7, these have been inlined at the source.
 */
public class Bullets {
    ...
    public static void load() {
        ...
        placeholder =
                new BasicBulletType(2.5f, 9, "ohno") {
                    {
                        width = 7f;
                        height = 9f;
                        lifetime = 60f;
