...
public interface Publishable {
    ...
    /**
     * adds a steam ID to this item once it's published. should save the item to make sure this
     * change is persisted.
     */
    ...
    /**
     * @return standard steam listing description, may be null. this is editable by users after
     * release.
     */
    @Nullable
    ...
    /**
     * @return a folder with everything needed for this piece of content in it; does not need to be
     * a copy.
     */
     ...
     *
     * @return true to signify that everything is cool and good, or false to significy that the user
     * has done something wrong. if false is returned, make sure to show a dialog explaining the
     * error.
     */
