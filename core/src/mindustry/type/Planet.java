...
public class Planet extends UnlockableContent {
    ...
    /**
     * Whether this planet is tidally locked relative to its parent - see
    ...
    /**
     * If true, blocks in the radius of the core will be removed and "built up" in a shockwave upon
     * landing.
     */
    ...
    /**
     * Parent body that this planet orbits around. If null, this planet is considered to be in the
    ...
    public Planet(String name, Planet parent, float radius) {
        ...
        orbitRadius =
                parent == null ? 0f : (parent.totalRadius + parent.orbitSpacing + totalRadius);
    ...
    public @Nullable Sector getLastSector() {
        ...
        return sectors.get(
                Math.min(
                        Core.settings.getInt(name + "-last-sector", startSector),
                        sectors.size - 1));
    }
    ...
    /**
     * Adds this planet's offset relative to its parent to the vector. Used for calculating world
     * positions.
     */
    ...
    /**
     * Gets the absolute world position of this planet, taking into account all parents. O(n)
     * complexity.
     */
