...
public class LogicDialog extends BaseDialog {
    ...
    private void setup() {
        ...
        buttons.button(
                                        ...
                                        p.table(
                                                ...
                                                t -> {
                                                    ...
                                                    for (var s : executor.vars) {
                                                        ...
                                                        // TODO type name does not update, is this
                                                        // important?
                                                        t.add(
                                                                        new Image(
                                                                                Tex.whiteui,
                ...
                .name("variables")
                .disabled(b -> executor == null || executor.vars.length == 0);
        ...
        buttons.button(
                        ...
                        () -> {
                            ...
                            dialog.cont
                                    ...
                                    .fill()
                                    .maxHeight(Core.graphics.getHeight() * 0.8f);
                            dialog.addCloseButton();
                            dialog.show();
                        })
