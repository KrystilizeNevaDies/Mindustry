...
public class SectorGenerateDialog extends BaseDialog {
    ...
    void setup() {
        ...
        cont.field(
                ...
                .valid(
                        text ->
                                planet.sectors.size > Strings.parseInt(text, 99999)
                                        && Strings.parseInt(text, 9999) >= 0);
        ...
        cont.label(
                        () ->
                                "[ "
                                        + planet.sectors.get(sector).getSize()
                                        + "x"
                                        + planet.sectors.get(sector).getSize()
                                        + " ]")
                .color(Pal.accent)
