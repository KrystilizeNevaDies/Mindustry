...
public class WaveInfoDialog extends BaseDialog {
                                                                                ...
                                                                                dialog.cont.pane(
                                                                                        p -> {
                                                                                            ...
                                                                                            for (var
                                                                                                ...
                                                                                                // only display first 20 spawns, you don't need to
                                                                                                // see more.
                                                                                                if (i
                                                                                                        >= 20) {
                                                                                                    break;
        ...
        dialog.cont.pane(
                p -> {
                    ...
                    for (StatusEffect effect : content.statusEffects()) {
                        if (effect != StatusEffects.none && (effect.isHidden() || effect.reactive))
                            continue;
    ...
    enum Sort {
        begin(
                Structs.comps(
                        Structs.comparingFloat(g -> g.begin),
                        Structs.comparingFloat(g -> g.type.id))),
        health(
                Structs.comps(
                        Structs.comparingFloat(g -> g.type.health),
                        Structs.comparingFloat(g -> g.begin))),
        type(
                Structs.comps(
                        Structs.comparingFloat(g -> g.type.id),
