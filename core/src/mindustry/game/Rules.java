...
/**
 * Defines current rules on how the game should function. Does not store game state, just
 * configuration.
 */
public class Rules {
    /**
    ...
    /**
     * Whether the waves come automatically on a timer. If not, waves come when the play button is
     * pressed.
     */
    ...
    /**
     * Whether a gameover can happen at all. Set this to false to implement custom gameover
     * conditions.
     */
    ...
    /**
     * If true, dead teams in PvP automatically have their blocks & units converted to derelict upon
     * death.
     */
    ...
    /**
     * If true, every enemy block in the radius of the (enemy) core is destroyed upon death. Used
     * for campaign maps.
     */
    ...
    public static class TeamRule {
        /**
         * Whether, when AI is enabled, ships should be spawned from the core. TODO remove /
         * unnecessary?
         */
