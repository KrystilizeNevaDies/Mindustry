...
public class EventType {
    ...
    /**
     * Called when a game begins and the world tiles are loaded. Entities are not yet loaded at this
     * stage.
     */
    ...
    /**
     * Called when a bullet damages a building. May not be called for all damage events! This event
     * is re-used! Never do anything to re-raise this event in the listener.
     */
    ...
    /**
     * Called *before* a tile has changed. WARNING! This event is special: its instance is reused!
     * Do not cache or use with a timer. Do not modify any tiles inside listeners that use this
     * tile.
     */
    ...
    /**
     * Called *after* a tile has changed. WARNING! This event is special: its instance is reused! Do
     * not cache or use with a timer. Do not modify any tiles inside listener code.
     */
    ...
    /**
     * Called after a building's team changes. Event object is reused, do not nest!
     */
    ...
    /**
     * Called when block building begins by placing down the ConstructBlock. The tile's block will
     * nearly always be a ConstructBlock.
     */
    ...
    /**
     * Called when a player or drone begins building something. This does not necessarily happen
     * when a new ConstructBlock is created.
     */
    ...
    /**
     * Called right before a block is destroyed. The tile entity of the tile in this event cannot be
    ...
    /**
     * Called after player confirmed it has received world data and is ready to play. Note that if
     * this is the first world receival, then player.con.hasConnected is false.
     */
    ...
    /**
     * Called after connecting; when a player receives world data and is ready to play. Fired only
     * once, after initial connection.
     */
