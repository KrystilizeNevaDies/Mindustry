...
public class Waves {
    ...
    public static Seq<SpawnGroup> generate(
            float difficulty, Rand rand, boolean attack, boolean airOnly) {
        return generate(difficulty, rand, attack, airOnly, false);
    }

    public static Seq<SpawnGroup> generate(
            float difficulty, Rand rand, boolean attack, boolean airOnly, boolean naval) {
        UnitType[][] species = {
        ...
        Intc createProgression =
                start -> {
                    ...
                    for (int i = start; i < cap; ) {
                        ...
                        int next =
                                rand.random(8, 16)
                                        + (int) Mathf.lerp(5f, 0f, difficulty)
                                        + curTier * 4;
                        ...
                        out.add(
                                new SpawnGroup(
                                        curSpecies[Math.min(curTier, curSpecies.length - 1)]) {
                                    {
        ...
        out.add(
                new SpawnGroup(Structs.random(species)[bossTier]) {
                    {
                        unitAmount = 1;
                        begin = bossWave;
                        spacing = bossSpacing;
