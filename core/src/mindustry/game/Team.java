...
public class Team implements Comparable<Team> {
    ...
    public static final Team derelict = new Team(0, "derelict", Color.valueOf("4d4e58")),
            ...
            malis =
                    new Team(
                            ...
                            Color.valueOf("c195fb"),
                            Color.valueOf("665c9f"),
                            Color.valueOf("484988")),
    ...
    green =
            new Team(
                    ...
                    "green",
                    Color.valueOf(
                            "54d67d")), // Color.valueOf("96f58c"), Color.valueOf("54d67d"),
    // Color.valueOf("28785c")),
    blue =
            new Team(
                    5,
                    "blue",
                    Color.valueOf(
                            "6c87fd")); // Color.valueOf("85caf9"), Color.valueOf("6c87fd"),
    // Color.valueOf("3b3392")
    ...
    static {
        ...
        for (int i = 6; i < all.length; i++) {
            new Team(
                    ...
                    Color.HSVtoRGB(
                            360f * Mathf.random(),
                            100f * Mathf.random(0.6f, 1f),
                            100f * Mathf.random(0.8f, 1f),
                            1f));
        }
    ...
    /**
     * @return the core items for this team, or an empty item module. Never add to the resulting
     * item module, as it is mutable.
     */
