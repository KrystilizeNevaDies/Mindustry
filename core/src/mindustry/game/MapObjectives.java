...
public class MapObjectives implements Iterable<MapObjective>, Eachable<MapObjective> {
    ...
    static {
        ...
        registerMarker(ShapeTextMarker::new, MinimapMarker::new, ShapeMarker::new, TextMarker::new);
    }
    ...
    public void update() {
        eachRunning(
                obj -> {
                    ...
                    // objectives cannot get completed on the client, but they do try to update for
                    // timers and
                    // such
    ...
    /**
     * @return True if map rules should be synced. Reserved for {@link Vars#logic}; do not invoke
     * directly!
     */
     ...
     */
    public <T extends MapObjective> void eachRunning(
            Boolf<? super MapObjective> pred, Cons<T> cons) {
     ...
     */
    public abstract static class MapObjective {
        public @Nullable
        ...
        /**
         * Temporary container to store references since this class is static. Will immediately be
         * flattened.
         */
        ...
        /**
         * @return True if all {@link #parents} are completed, rendering this objective able to
         * execute.
         */
        ...
        /**
         * @return This objective, with the given child's parents added with this, for chaining
         * operations.
         */
        ...
        /**
         * @return This objective, with the given parent added to this objective's parents, for
         * chaining operations.
         */
        ...
        /**
         * @return The localized type-name of this objective, defaulting to the class simple name
         * without the "Objective" prefix.
         */
        public String typeName() {
            String className = getClass().getSimpleName().replace("Objective", "");
            return Core.bundle == null
                    ? className
                    : Core.bundle.get("objective." + className.toLowerCase() + ".name", className);
        }
    }
    ...
    /**
     * Produce a specific piece of content in the tech tree (essentially research with different
     * text).
     */
    ...
    public static class ItemObjective extends MapObjective {
        ...
        public String text() {
            return Core.bundle.format(
                    "objective.item",
                    state.rules.defaultTeam.items().get(item),
                    amount,
                    item.emoji(),
                    item.localizedName);
        }
    ...
    public static class CoreItemObjective extends MapObjective {
        ...
        public String text() {
            return Core.bundle.format(
                    "objective.coreitem",
                    state.stats.coreItemCount.get(item),
                    amount,
                    item.emoji(),
                    item.localizedName);
        }
    ...
    public static class UnitCountObjective extends MapObjective {
        ...
        public String text() {
            return Core.bundle.format(
                    "objective.buildunit", count, unit.emoji(), unit.localizedName);
        }
    }
    ...
    public static class CommandModeObjective extends MapObjective {
        ...
        public boolean update() {
            return headless
                    || control.input.selectedUnits.contains(
                    u -> u.isCommandable() && u.command().hasCommand());
        }
     ...
     */
    public abstract static class ObjectiveMarker {
        /**
        ...
        /**
         * @return The localized type-name of this objective, defaulting to the class simple name
         * without the "Marker" prefix.
         */
        public String typeName() {
            String className = getClass().getSimpleName().replace("Marker", "");
            return Core.bundle == null
                    ? className
                    : Core.bundle.get("marker." + className.toLowerCase() + ".name", className);
        }
    ...
    /**
     * For {@code float} or similar data structures, such as {@link Vec2}; multiplies the UI input
     * by {@link Vars#tilesize}.
     */
    @Target(FIELD)
    @Retention(RUNTIME)
