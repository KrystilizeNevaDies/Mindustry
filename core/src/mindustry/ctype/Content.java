...
public abstract class Content implements Comparable<Content> {
    ...
    /**
     * Returns the type name of this piece of content. This should return the same value for all
     * instances of this content type.
     */
    ...
    /**
     * Called after all content is created, only on non-headless versions. Use for loading regions
     * or other image data.
     */
    public void load() {
    }
