...
public class Vars implements Loadable {
    ...
    /**
     * Whether to enable various experimental features (e.g. spawn positions for spawn groups) TODO
     * change
     */
    ...
    public static final ContentType[] defaultContentIcons = {
            ContentType.item, ContentType.liquid, ContentType.block, ContentType.unit
    };
    /**
    ...
    public static final String reportIssueURL =
            "https://github.com/Anuken/Mindustry/issues/new?labels=bug&template=bug_report.md";
    /**
     ...
     * icon sizes for UI
     */
    public static final float iconXLarge = 8 * 6f,
            iconLarge = 8 * 5f,
            iconMed = 8 * 4f,
            iconSmall = 8 * 3f;
    /**
    ...
    /**
     * Whether to draw shadows of blocks at map edges and static blocks. Do not change unless you
    ...
    public static void init() {
        ...
        if (loadLocales) {
            ...
            Arrays.sort(
                    locales,
                    Structs.comparing(
                            LanguageDialog::getDisplayName, String.CASE_INSENSITIVE_ORDER));
        ...
        javaPath =
                new Fi(OS.prop("java.home")).child("bin/java").exists()
                        ? new Fi(OS.prop("java.home")).child("bin/java").absolutePath()
                        : Core.files.local("jre/bin/java").exists()
                        ? Core.files.local("jre/bin/java").absolutePath()
                        : "java";
