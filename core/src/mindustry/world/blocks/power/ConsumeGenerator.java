...
public class ConsumeGenerator extends PowerGenerator {
    ...
    public void setStats() {
        ...
        if (outputLiquid != null) {
            stats.add(
                    Stat.output,
                    StatValues.liquid(outputLiquid.liquid, outputLiquid.amount * 60f, true));
        }
    }
    ...
    public class ConsumeGeneratorBuild extends GeneratorBuild {
        ...
        public void updateTile() {
            ...
            if (valid && Mathf.chanceDelta(effectChance)) {
                generateEffect.at(
                        x + Mathf.range(generateEffectRange), y + Mathf.range(generateEffectRange));
            }
            ...
            // generation time always goes down, but only at the end so consumeTriggerValid doesn't
            // assume
            // fake items
