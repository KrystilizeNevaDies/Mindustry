...
public class ShockwaveTower extends Block {
    ...
    public Color waveColor = Pal.accent,
            ...
            shapeColor = Color.valueOf("f29c83");
    ...
    public class ShockwaveTowerBuild extends Building {
        ...
        public void updateTile() {
            if (potentialEfficiency > 0
                    && (reloadCounter += Time.delta) >= reload
                    && timer(timerCheck, checkInterval)) {
                targets.clear();
                ...
                if (targets.size > 0) {
                    ...
                    float waveDamage =
                            Math.min(bulletDamage, bulletDamage * falloffCount / targets.size);
        ...
        public void draw() {
            ...
            Fill.poly(
                    ...
                    y,
                    shapeSides,
                    shapeRadius * potentialEfficiency,
                    Time.time * shapeRotateSpeed);
            Draw.color();
        }
