...
public class DirectionalForceProjector extends Block {
            ...
            b -> {
                if (b.team != paramEntity.team && b.type.absorbable) {
                    ...
                    if (Intersector.intersectSegments(
                            ...
                            b.y + b.vel.y * (Time.delta + deltaAdd),
                            p1.x,
                            p1.y,
                            p2.x,
                            p2.y,
    ...
    public void setBars() {
        ...
        addBar(
                "shield",
                (DirectionalForceProjectorBuild entity) ->
                        new Bar(
                                "stat.shieldhealth",
                                Pal.accent,
                                () ->
                                        entity.broken
                                                ? 0f
                                                : 1f - entity.buildup / (shieldHealth))
                                .blink(Color.white));
    }
    ...
    public class DirectionalForceProjectorBuild extends Building {
        ...
        public void updateTile() {
            ...
            if (buildup > 0 && false) {
                ...
                // if(cons.valid(this)){
                //    cons.update(this);
                //    scale *= (cooldownLiquid * (1f + (liquids.current().heatCapacity - 0.4f) *
                // 0.9f));
                // }
        ...
        public void deflectBullets() {
            ...
            if (shieldRadius > 0 && !broken) {
                ...
                Groups.bullet.intersect(
                        x + Tmp.r1.x, y + Tmp.r1.y, Tmp.r1.width, Tmp.r1.height, dirShieldConsumer);
            }
        }
        ...
        public void drawShield() {
            if (!broken && shieldRadius > 0) {
                ...
                if (renderer.animateShields) {
                    ...
                    Tmp.v1
                            .set(length - size / 2f, (shieldRadius + size / 2f))
                            .rotate(rot)
                            .add(this);
                    Tmp.v2
                            .set(length - size / 2f, -(shieldRadius + size / 2f))
                    ...
                    for (int i : Mathf.signs) {
                        Tmp.v1
                                .set(length - size / 2f, (shieldRadius + size / 2f) * i)
                                .rotate(rot)
                                .add(this);
                        Tmp.v3
                                .set(length + size / 2f, (shieldRadius + size / 2f) * i)
