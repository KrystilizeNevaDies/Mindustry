...
public class LiquidBlock extends Block {
    ...
    public static void drawTiledFrames(
            int size, float x, float y, float padding, Liquid liquid, float alpha) {
        ...
        for (int sx = 0; sx < size; sx++) {
            for (int sy = 0; sy < size; sy++) {
                ...
                float squishX = rightBorder + tilesize / 2f - bounds,
                        squishY = topBorder + tilesize / 2f - bounds;
                float ox = 0f, oy = 0f;
