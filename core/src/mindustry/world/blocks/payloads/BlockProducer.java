    ...
    public BlockProducer(String name) {
        ...
        consume(
                new ConsumeItemDynamic(
                        (BlockProducerBuild e) ->
                                e.recipe() != null ? e.recipe().requirements : ItemStack.empty));
    }
                ...
                (BlockProducerBuild entity) ->
                        new Bar(
                                ...
                                () ->
                                        entity.recipe() == null
                                                ? 0f
                                                : (entity.progress / entity.recipe().buildCost)));
    }
        ...
        public void draw() {
            ...
            if (recipe != null) {
                ...
                Lines.lineAngleCenter(
                        x + Mathf.sin(time, 10f, Vars.tilesize / 2f * recipe.size + 1f),
                        y,
                        90,
                        recipe.size * Vars.tilesize + 1f);
