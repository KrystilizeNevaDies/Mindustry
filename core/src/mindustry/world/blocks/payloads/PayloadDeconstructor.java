    ...
    public class PayloadDeconstructorBuild extends PayloadBlockBuild<Payload> {
                ...
                Draw.draw(
                        ...
                        () -> {
                            Drawf.construct(
                                    ...
                                    deconstructing.icon(),
                                    Pal.remove,
                                    deconstructing instanceof BuildPayload ? 0f : payRotation - 90f,
                                    1f - progress,
                                    1f - progress,
                                    time);
                            ...
                            Lines.lineAngleCenter(
                                    x + Mathf.sin(time, 20f, tilesize / 2f * block.size - 3f),
                                    y,
                                    90f,
                                    block.size * tilesize - 6f);
        ...
        public boolean acceptUnitPayload(Unit unit) {
            return payload == null
                    ...
                    && !unit.spawnedByCore
                    && unit.type.getTotalRequirements().length > 0
        ...
        public void updateTile() {
            ...
            if (deconstructing != null) {
                        ...
                        accum[i] +=
                                reqs[i].amount
                                        * (payload instanceof BuildPayload
                                        ? state.rules.buildCostMultiplier
                                        : 1f)
                                        * realShift;
                    }
                }
                ...
                // transfer items from accumulation buffer into block inventory when they reach
                // integers
                for (int i = 0; i < reqs.length; i++) {
