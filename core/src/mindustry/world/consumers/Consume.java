...
public abstract class Consume {
    ...
    /**
     * @return if true, this consumer will be ignored in the consumer list (no updates or valid()
     * checks)
     */
    ...
    /**
     * @return [0, 1] efficiency multiplier based on input. Returns 0 if not valid in subclasses.
     * Should return fraction if needs are partially met.
     */
    ...
    /**
     * @return multiplier for efficiency - this can be above 1. Will not influence a building's base
     * efficiency value.
     */
