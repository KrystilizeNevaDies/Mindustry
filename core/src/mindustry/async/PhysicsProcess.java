...
public class PhysicsProcess implements AsyncProcess {
    private static final int layers = 3, layerGround = 0, layerLegs = 1, layerFlying = 2;
    ...
    public void begin() {
        ...
        for (Unit entity : group) {
            ...
            ref.body.layer =
                    entity.type.allowLegStep && entity.type.legPhysicsLayer
                            ? layerLegs
    ...
    public static class PhysicsWorld {
        ...
        public void update() {
            ...
            for (int i = 0; i < bodySize; i++) {
                ...
                // for clients, the only body that collides is the local one; all other physics
                // simulations
