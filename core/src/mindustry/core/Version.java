...
public class Version {
    ...
    public static void init() {
        ...
        Fi file =
                OS.isAndroid || OS.isIos
                        ...
                        : new Fi("version.properties", FileType.internal);
    ...
    /**
     * @return whether the current game version is greater than the specified version string, e.g.
     * "120.1"
     */
    ...
    /**
     * @return whether the version numbers are greater than the specified version string, e.g.
     * "120.1"
     */
    public static boolean isAtLeast(int build, int revision, String str) {
        ...
        if (dot != -1) {
            int major = Strings.parseInt(str.substring(0, dot), 0),
                    minor = Strings.parseInt(str.substring(dot + 1), 0);
    ...
    public static String combined() {
        ...
        return (type.equals("official") ? modifier : type)
                + " build "
                + build
                + (revision == 0 ? "" : "." + revision);
    }
