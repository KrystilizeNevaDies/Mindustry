...
// - it can be used server-side (unlike FactoryDustry, which is a client-side texture pack that
...
public class ModTestHAI extends GenericModTest {
    ...
    public void begin() {
        ...
        grabMod(
                "https://github.com/Eschatologue/Heavy-Armaments-Industries/archive/d996e92dcf9a30a6acb7b3bfdfb6522dddc3804c.zip");
