...
/**
 * This class provides objects commonly used by power related unit tests. For now, this is a helper
 * with static methods, but this might change.
 *
 * <p>Note: All tests which subclass this will run with a fixed delta of 0.5!
 */
public class PowerTestFixture {
    ...
    protected static Tile createFakeTile(int x, int y, Block block) {
        try {
            ...
            // Using the Tile(int, int, byte, byte) constructor would require us to register any
            // fake
            // block or tile we create
            // Since this part shall not be part of the test and would require more work anyway, we
            // manually set the block and floor
            ...
            // Simulate the "changed" method. Calling it through reflections would require half the
            // game
            // to be initialized.
            ...
            // Assign incredibly high health so the block does not get destroyed on e.g. burning
            // Blast
            // Compound
            block.health = 100000;
